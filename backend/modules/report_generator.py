...
class ReportGenerator:
    ...
    def _generate_pdf_report(self, scan_data, filepath):
        ...
        # Title page
        story.append(Paragraph("Network Scanner Security Assessment Report", self.title_style))
...
<head>
    ...
    <title>Network Scanner Security Assessment Report</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>🛡️ Network Scanner Security Assessment Report</h1>
        ...
        <div class="footer">
            <p>This report was generated by Network Scanner - AI-Assisted Vulnerability Assessment Tool</p>
